...
export default class Player {
  ...
  async play () {
    await this._client.fetch('me/player/play', {
      method: 'PUT'
    })
  }

  async pause () {
    await this._client.fetch('me/player/pause', {
      method: 'PUT'
    })
  }
  ...
  async next () {
    await this._client.fetch('me/player/next', {
      method: 'POST'
    })
  }

  async previous () {
    await this._client.fetch('me/player/previous', {
      method: 'POST'
    })
  }
